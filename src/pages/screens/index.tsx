import { screens } from "@/entities/product/products";
...
const Screens = () => {
    ...
    return (
        <PageTemplate>
            <ProductList items={screens} />
            {!screens.length && <div className="flex flex-col gap-4 justify-center items-center w-full mt-8">
